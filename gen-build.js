...
function playMp3Seq(names){var i=0;function next(){if(i>=names.length)return;var a=new Audio('audio/'+names[i]+'.mp3');a.play();a.onerror=function(){i++;setTimeout(next,100);};a.onended=function(){i++;setTimeout(next,200);};}next();}
