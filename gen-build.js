...
/* -- 拼音 -- */
.pygrid{position:absolute;top:330px;left:0;right:0;display:flex;flex-wrap:wrap;justify-content:center;gap:20px 30px;z-index:2;padding:0 60px;}
.pycard{width:280px;background:var(--card);border-radius:28px;box-shadow:var(--shadow);border:5px solid #c3dafe;padding:16px 20px;text-align:center;}
.pycard .pylead{font-family:'Nunito',sans-serif;font-weight:900;font-size:56px;color:var(--blue);margin-bottom:4px;}
.pycard .pytones{font-family:'Nunito',sans-serif;font-weight:800;font-size:36px;color:var(--py);margin:4px 0;}
.pycard .pyeg{font-family:'Noto Serif SC',serif;font-weight:900;font-size:48px;color:var(--ink);}
.pycard .pyword{font-family:'Noto Serif SC',serif;font-size:26px;color:var(--ink);opacity:.68;margin-top:2px;}
.pycard .pyspk{width:46px;height:46px;font-size:20px;margin-top:8px;}
`;
